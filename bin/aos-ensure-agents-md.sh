...
# This is a worktree utility for subagents, not a supervision script, so it does
# not call aos-guard.sh.
# Usage: aos-ensure-agents-md.sh [repo-or-worktree-dir]
set -eu

usage() {
  echo "usage: aos-ensure-agents-md.sh [repo-or-worktree-dir]" >&2
}
